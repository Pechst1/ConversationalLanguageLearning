...
- **Status (2026-09-24): built, awaiting the owner's design review** (branch `wp-s7-momentum`, no migration).
  ...
  - **Resolved (2026-09-25):** `unified_srs.contrast_partner_refs` now also reads the v2 syllabus block
    (`source_refs["syllabus"]["contrast_partners"]`), so WP-S4's picker seats contrast rules on v2.
...
- **Status (2026-09-24): landed** (`app/services/forge_metrics.py`, `tests/test_wp_s8_forge_metrics.py`).
  ...
  - **Simulation report:** `scripts/forge_speed_report.py` (≈ 1 s; `--write-doc` rewrites the block below).
    ...
    - **At 70 %,** the ladder leaves half of its rules unheld (∞), and the    - **Resolved (2026-09-25):** forge + Rappel held fewer rules than the forge alone.
      - **Cause (verified over 8 seeds):** the journey's Rappel runs first and reschedules every due
        rule, so the forge's picker found none due. Those rules only ever got the Rappel's low-rung item,
        never the staircase to free use, and held needs free use on two separate days.
      - **Fix:** a rule reviewed today and not yet held stays on the forge's due list
        (`forge_picker._review_queue`, and the simulation mirrors it).
      - **Effect:** with Rappel, rules held by day 120 went Soutenu 85 % 27 → 38 / 51 and Intensif 85 %
        36 → 46 / 68, and Intensif's median days-to-held went 43 → 24.
      - **Residual gap:** about 5 % below the forge alone, because the Rappel's same-day credit keeps the
        schedule and the forge only climbs the rung.is measured on real learners.

<!-- forge-speed-report:begin -->
_Generated by `scripts/forge_speed_report.py` (1.1 s; 150 simulated days, one séance a day, 25 s per item; rules judged if introduced ≥ 45 days before the end; «held by day N» counts rules held out of rules introduced by then)._
...
| Léger | 70 % | **Forge** | 51 | 18 | 14 / 15 | 6 / 8 | 13 / 17 |
| Léger | 85 % | Old ladder | 16 | 59 | 12 / 15 | 1 / 8 | 7 / 17 |
| Léger | 85 % | **Forge** | 27 | 17 | 15 / 15 | 6 / 8 | 14 / 17 |
| Léger | 95 % | Old ladder | 14 | 55 | 13 / 15 | 0 / 8 | 8 / 17 |
| Léger | 95 % | **Forge** | 18 | 23 | 15 / 15 | 3 / 8 | 13 / 17 |
| Régulier | 70 % | Old ladder | ∞ | 63 | 15 / 30 | 0 / 17 | 8 / 34 |
| Régulier | 70 % | **Forge** | 46.5 | 27 | 27 / 30 | 9 / 17 | 23 / 34 |
| Régulier | 85 % | Old ladder | 19 | 55 | 22 / 30 | 0 / 17 | 13 / 34 |
| Régulier | 85 % | **Forge** | 27.5 | 18 | 29 / 30 | 10 / 17 | 28 / 34 |
| Régulier | 95 % | Old ladder | 14.5 | 55 | 26 / 30 | 1 / 17 | 18 / 34 |
| Régulier | 95 % | **Forge** | 20 | 21 | 28 / 30 | 8 / 17 | 24 / 34 |
| Soutenu | 70 % | Old ladder | ∞ | 63 | 21 / 45 | 0 / 25 | 11 / 51 |
| Soutenu | 70 % | **Forge** | 41 | 26 | 38 / 45 | 11 / 25 | 32 / 51 |
| Soutenu | 85 % | Old ladder | 19 | 55 | 34 / 45 | 1 / 25 | 23 / 51 |
| Soutenu | 85 % | **Forge** | 24 | 21 | 45 / 45 | 13 / 25 | 38 / 51 |
| Soutenu | 95 % | Old ladder | 14 | 55 | 39 / 45 | 2 / 25 | 25 / 51 |
| Soutenu | 95 % | **Forge** | 18 | 26 | 43 / 45 | 13 / 25 | 37 / 51 |
| Intensif | 70 % | Old ladder | ∞ | 72 | 30 / 60 | 1 / 34 | 16 / 68 |
| Intensif | 70 % | **Forge** | 38 | 24 | 52 / 60 | 17 / 34 | 44 / 68 |
| Intensif | 85 % | Old ladder | 17 | 59 | 46 / 60 | 1 / 34 | 29 / 68 |
| Intensif | 85 % | **Forge** | 22 | 24 | 58 / 60 | 19 / 34 | 46 / 68 |
| Intensif | 95 % | Old ladder | 13 | 55 | 54 / 60 | 3 / 34 | 38 / 68 |
| Intensif | 95 % | **Forge** | 17.5 | 28 | 56 / 60 | 19 / 34 | 49 / 68 |
