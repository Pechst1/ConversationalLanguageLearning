...
|---|---------|----------|-------|--------------|-------------|-------|
| 0 | Home (La Une) | `/atelier` today | done | `docs/atelier-home-rework-design-brief.md` | **done** | Reference implementation. Dead parcours code removal in progress. |
...
| 3 | Notebook | `/notebook`, `/grammar`, `/vocabulary` | **done** — `docs/overhaul-notebook.md` | **drafted** — `docs/overhaul-notebook.md` §5 | waiting on design package | Audit and self-contained "Les Cahiers" brief completed 2026-07-18. Implementation waits for the owner-provided Claude Design package. |
...
| 5 | Settings | `/settings` | **done** — `docs/overhaul-settings.md` | **drafted** — `docs/overhaul-settings.md` §5 | waiting on design package | "Le Bureau" audit and brief completed 2026-07-18. Visual port waits for the owner-provided Claude Design package. |
